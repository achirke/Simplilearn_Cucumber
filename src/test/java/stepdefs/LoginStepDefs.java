...
public class LoginStepDefs {
	...
	WebDriver driver = Baseclass.driver;
	 ...
	 @Given("^User has navigated to the login page$")
	    ...
	    public void user_enteres_correct_username_and_password() throws Throwable {
	    ...
	    @When("^User enteres correct username \"([^\"]*)\" and password \"([^\"]*)\"$")
	    public void user_enteres_correct_username_something_and_password_something(String UserNameVal, String PasswordVal) throws Throwable {
